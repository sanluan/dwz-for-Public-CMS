	...
	$.extend($.fn, {
		...
		genTree : function(options) {
			...
			if (aClass == "checked" ) {
				...
				$(">div>.ckbox", parent).find("input").attr("checked", "checked");
	...
	$.fn.extend({
		...
		itemDetail : function() {
			return this.each(function() {
				...
				if (addButTxt ) {
					var $addBut = $('<div class="button"><div class="buttonContent"><button type="button">' + addButTxt + '</button></div></div>').insertBefore($table)
							.find("button");
