...
var DWZ = {
	...
	init: function(pageFrag, options) {
		var op = $.extend({
			loginUrl: "login.html", loginTitle: null, ckeditorResources: null, ueditorResources: null, codemirrorResources : null, callback: null, debug: false, statusCode: {}
		}, options);
			...
			_doc.bind(DWZ.eventType.pageClear, function(event) {
				...
				$("textarea.editor", $(box)).each(function() {
					if('ckeditor'==$(this).attr('editorType')){
						delete CKEDITOR.instances[$(this).data("id")];
					}else{
						delete UE.instants[$(this).data("id")];
					}
				});
 ...
 *         not mm! Examples: "MMM d, y" matches: January 01, 2000 Dec 1, 1900
...
var navTab = {
	...
	_getScrollBarW: function() {
		return this.componentBox.width() - 141;
	} ,
				...
				switch (field.type) {
					...
					case 'lookup':
						...
						html = '<input type="hidden" name="' + field.lookupGroup + '.' + field.lookupPk + suffix + '"/>' + '<input type="text" name="' + field.name + '"'
								...
								+ field.lookupUrl + '" lookupGroup="' + field.lookupGroup + '" ' + suggestFrag + ' lookupPk="' + field.lookupPk + '" title="查找选择" ' + attrFrag + '>查找选择</a>';
						break;
					case 'attach':
						html = '<input type="hidden" name="' + field.lookupGroup + '.' + field.lookupPk + suffix + '"/>' + '<input type="text" name="' + field.name + '" size="'
								...
								+ '" ' + suffixFrag + ' lookupPk="' + field.lookupPk + '" width="560" height="300" title="查找选择" ' + attrFrag + '>查找选择</a>';
						break;
					case 'enum':
						$.ajax({
					...
					case 'date':
						html = '<input type="text" name="' + field.name + '" value="' + field.defaultVal + '" class="date ' + field.fieldClass + '" dateFmt="' + field.patternDate
								+ '" size="' + field.size + '" ' + attrFrag + '/>' + '<a class="inputDateButton" href="javascript:void(0)">选择</a>';
						break;
					case 'checkbox':
